...
- Visual Studio Code
- nvm / nodejs / npm / npx / yarn
- Typescript
- [Solidity](https://solidity-es.readthedocs.io/es/latest/) (Writing Smart Contracts & Tests)
- [Hardhat](https://hardhat.org/) (Development Framework)
- [Ethers.js](https://docs.ethers.io/v5/) (Blockchain Interaction)
- [QuickNode](https://www.quicknode.com/) (To deploy smart contracts)
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/dappsar/dao-template)
...
1. Clone this repo:
```
git clone https://github.com/dappsar/dao-template
cd dao-template
```
...
See the [open issues](https://github.com/dappsar/dao-template/issues) for a full list of proposed features (and known issues).
